...
```swift
// File: apps/macos-app/VelociraptorMacOS/VelociraptorMacOSApp.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Models/AppState.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Models/ConfigurationData.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Views/ContentView.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Services/KeychainManager.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Services/DeploymentManager.swift
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Views/Steps/DeploymentTypeStepView.swift
import SwiftUI
...
```swift
// File: apps/macos-app/VelociraptorMacOS/Views/IncidentResponse/IncidentResponseView.swift
import SwiftUI
...
cat > apps/macos-app/VelociraptorMacOS/VelociraptorMacOS.entitlements << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
