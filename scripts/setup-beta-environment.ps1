...
# Test GUI launch (apps/gui or scripts/ after reorganization)
try {
    Write-Host "Testing GUI launch..." -NoNewline
    . .\apps\gui\VelociraptorGUI.ps1 -StartMinimized
    Write-Host " ✅ Success" -ForegroundColor Green
} catch {
    Write-Host " ❌ Failed: `$(`$_.Exception.Message)" -ForegroundColor Red
}

# Test module imports (scripts/ after reorganization)
try {
    Write-Host "Testing module imports..." -NoNewline
    . .\scripts\Deploy_Velociraptor_Server.ps1 -WhatIf
    Write-Host " ✅ Success" -ForegroundColor Green
} catch {
    Write-Host " ❌ Failed: `$(`$_.Exception.Message)" -ForegroundColor Red
}
